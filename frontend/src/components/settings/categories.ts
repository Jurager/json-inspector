...
export type Category = {
  ...
  tile: string
  /**
   * Drawn and not offered: the design gives these four a place and the app has nothing to put in
   * them — no account, no proxy in the engine, no keychain, no export formats. Their rows are the
   * drawing's, with every control switched off and a sentence saying why.
   */
  soon?: boolean
}

export const CATEGORIES: readonly Category[] = [
  { id: 'account', icon: 'user', tile: 'var(--accent)', soon: true },
...
type LiveId = 'general' | 'appearance' | 'requests' | 'updates'
