...
type Store interface {
	...
	// and the two are addressed in the same id space. Nil is "not set here" — the level inherits.
	...
	NextPosition(ctx context.Context, collectionID string) (int64, error)
	...
	MoveNode(ctx context.Context, id string, collectionID string, position int64) error
	MoveCollection(ctx context.Context, id string, parentID string, position int64) error
