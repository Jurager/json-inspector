...
// The window's materials cannot be told "system": a window created without a theme keeps the
// default light attributes, which is how a dark app ends up with a light-tinted material behind it.
