...
func (s *DraftService) SetBodyKind(
	ctx context.Context,
	id domain.DraftID,
...
func (s *DraftService) SetBodyFile(
	ctx context.Context,
	id domain.DraftID,
	path string,
) (draft.State, error) {
...
func (s *DraftService) SetText(
	ctx context.Context,
	id domain.DraftID,
	in draft.TextInput,
) (draft.TextResult, error) {
...
func (s *DraftService) PatchRow(
	ctx context.Context,
	draftID domain.DraftID,
	kind domain.RowKind,
	id string,
	patch draft.RowPatch,
) (draft.State, error) {
...
func (s *DraftService) PatchDerived(
	ctx context.Context,
	draftID domain.DraftID,
...
func (s *DraftService) ObtainAuth(
	ctx context.Context,
	draftID domain.DraftID,
) (draft.State, error) {
...
func (s *DraftService) ForgetAuth(
	ctx context.Context,
	draftID domain.DraftID,
) (draft.State, error) {
...
func (s *DraftService) RemoveDerived(
	ctx context.Context,
	draftID domain.DraftID,
) (draft.State, error) {
...
func (s *DraftService) PickBodyFile(
	ctx context.Context,
	title string,
	kindName string,
) (string, error) {
